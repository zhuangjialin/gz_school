package com.lam.gz.impexp.excel.exp.handler;
...
public class HeaderContentWriterHandler extends BodyContentWriterHandler {
	...
	/** 
	 * 设置表头样式
	 * @see com.lam.gz.impexp.excel.exp.handler.BodyContentWriterHandler#setStyle(org.apache.poi.ss.usermodel.Workbook, org.apache.poi.ss.usermodel.CellStyle)
	 */
	@Override
