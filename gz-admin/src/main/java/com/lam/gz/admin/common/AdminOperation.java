...
public class AdminOperation extends Operation {
    ...
    public static final String PAGE_DEPART_USER_OP= "查询非机构的人员";
    ...
    public static final String PAGE_ROLE_USER_OP= "查询非角色的人员";
    ...
    public static final String PAGE_GROUP_USER_OP= "查询非小组的人员";
    ...
    public static final String CHANGE_PAWD= "修改密码";
