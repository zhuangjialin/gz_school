...
import com.lam.gz.admin.service.DepartmentService;
import com.lam.gz.admin.service.DepartmentUserService;
...
public class DepartmentController extends BaseController {
	...
	public ResultResponse listTree(DepartmentVo departmentVo){
		...
		if(!StringUtil.equals(AdminConstant.DEFAULT_TENANT_ID, TokenUtil.getTenantId())
