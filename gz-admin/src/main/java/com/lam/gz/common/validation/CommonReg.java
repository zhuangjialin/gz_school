...
public class CommonReg {
	...
	public static final String DATE_STR_REG = "^((([0-9]{2})(0[48]|[2468][048]|[13579][26]))|((0[48]|[2468][048]|[13579][26])00)-02-29)|([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8])))";
	/** 日期时间正则表达式，2018-02-05 12:45:12格式 */
	public static final String DATETIME_STR_REG = "^((([0-9]{2})(0[48]|[2468][048]|[13579][26]))|((0[48]|[2468][048]|[13579][26])00)-02-29)|([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))) (20|21|22|23|[0-1]?\\d):[0-5]?\\d:[0-5]?\\d$";
	/** 日期和日期时间正则表达式，2018-02-05格式 或 2018-02-05 12:45:12格式 */
	public static final String DATE_DATETIME_STR_REG = DATE_STR_REG+"|"+DATETIME_STR_REG;
