...
<div class="app-container calendar-list-container">
    <div class="filter-container">
        <el-form :inline="true" :model="listQuery">
	    	...
	    	<el-form-item class="el-form-item-u" label="文章标题">
                <el-input v-model="listQuery.classificationName" placeholder="输入关键字" style="width: 120px;" @keyup.enter.native="getList" class="filter-item"> </el-input>
            </el-form-item>
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row>
	    ...
	    <el-table-column label="文章标题" width="500px" align="center" >
            <template slot-scope="scope"><span>{{scope.row.classificationName}}</span></template>
        </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogVisible" class="dailog-body-u" 
    	custom-class="el-dialog-u-add-fileClassification" :append-to-body="true" :modal-append-to-body="false">

        <div class="el-dialog-panel">
            <el-form :model="form" :rules="rules" ref="form" label-width="80px" class="form-body-u">

            	<div style="display: table">
	               <el-form-item label="文章标题" prop="classificationName" style="float: left;width: 540px;">
	                   <el-input v-model="form.classificationName" placeholder="请输入文章标题"></el-input>
	               </el-form-item>
            	</div>
            	<div style="display: table">
	               <el-form-item label="权重" prop="sort" style="float: left;width: 540px;">
...
<style>
.el-dialog-u-add-fileClassification{
  width: 600px;
}
</style>

<script>
import {page, addObj, getObj, delObj, updObj, checkUnique} from '@/views/gz/api/fileClassification';
import $ from 'jquery';
...
export default {
  	...
  	data() {
    	return {
      		...
      		rules: {
            	classificationName: creatValid(check('文章标题', 2, 50)),
            	sort: creatValid(checkNumber('权重', 0, 1000)),
            	createTime: creatValid(check('创建时间', 2, 0)),
            	updateTime: creatValid(check('更新时间', 2, 0))
      		},
      		list: null,
      		pager:Pager(),
      		listLoading: true,
  	...
  	created() {
    	...
    	this.getList();
//  	this.isShowBtnAdd = hasPermission('fileClassification.insert');
//  	this.isShowBtnEdit = hasPermission('fileClassification.update');
//  	this.isShowBtnDel = hasPermission('fileClassification.delete');
