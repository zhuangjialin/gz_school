...
<div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row>
	    ...
	    <el-table-column label="类名" width="450px" align="center" >
...
<script>
import {page, addObj, getObj, delObj, updObj} from '@/views/admin/api/module';
import { reflush, getModule} from '@/views/admin/api/resource';
import $ from 'jquery';
