...
<script>
  import {addUser} from '@/views/admin/api/department';
  import {pageDepartUserToChoose } from '@/views/admin/api/user';
  import $ from 'jquery';
  import {Pager} from '@/components/pager/index';
  export default {
    name: 'selectDepartUser',
    props: {
      close: {
        type: Function,
        default: () => {
    ...
    methods: {
      getList() {
        ...
        pageDepartUserToChoose(this.listQuery).then(response => {
